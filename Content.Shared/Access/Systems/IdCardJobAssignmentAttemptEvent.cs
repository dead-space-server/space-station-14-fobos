...
/// <c>GeneralStationRecord.JobPrototype</c> change, but after name/access edits from the same action
/// have already gone through. Any system may cancel it to veto just the job portion of the
/// assignment.
///
