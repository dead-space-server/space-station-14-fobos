...
public sealed partial class HarpoonGunComponent : Component
{
    ...
    public SpriteSpecifier RopeSprite =
        new SpriteSpecifier.Rsi(new ResPath("_DeadSpace/Necromorfs/TheCircle/Weapon/melee/scythe-hook.rsi"), "rope");
