...
comms-console-announcement-title-soc = Special Operations Corps
comms-console-announcement-title-nukie = Syndicate Nuclear Operative
comms-console-announcement-title-taipan = NSS Taipan
...
comms-console-level-yellow-flavour-label = Prepare for atmospheric hazards
comms-console-level-red-flavour-label = Remain vigilant
comms-console-level-gamma-flavour-label = Exercise extreme caution
comms-console-level-sierra-flavour-label = Observe full quarantine procedures
comms-console-level-enigma-flavour-label = Prepare for immediate evacuation
comms-console-level-delta-flavour-label = Good luck
comms-console-level-epsilon-flavour-label = You're fired
comms-console-level-white-flavour-label = Watch for hostile reconnaissance
comms-console-level-zeta-flavour-label = Equip protective gear
comms-console-level-omega-flavour-label = Defend the installation at all costs
comms-console-level-audit-flavour-label = Prepare the installation for inspection
