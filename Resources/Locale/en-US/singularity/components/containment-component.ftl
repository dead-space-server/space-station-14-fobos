...
comp-containment-destabilization-announcement = Attention! Containment field generator destabilization detected; estimated location - { $location }. Initiate the field stabilization procedure immediately! Estimated time to fatal destabilization - one minute.
