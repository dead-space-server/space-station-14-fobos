...
reagent-name-chiyurizine = чьюризин
reagent-desc-chiyurizine = Покрытое тайной вещество, способное быстро и эффективно залечивать раны и нейтрализовать широкий спектр повреждений - от отравлений до ожогов. Его происхождение остаётся неизвестным. Любые попытки воспроизвести хотя бы отдалённо похожее вещество заканчивались крахом.