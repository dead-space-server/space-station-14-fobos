...
zombie-shuttle-call = Внимание! Системы мониторинга станции зафиксировали опасные биомаркеры у части экипажа. Специальный отряд направлен для локализации угрозы. Прибытие ожидается через 5 минут. Подготовьтесь к их прибытию и следуйте всем указаниям.
