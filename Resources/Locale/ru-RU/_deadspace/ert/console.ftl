...
ert-response-caused-messager-gamma =
    Внимание, станция! Первыми средствами связи командования были переданы тревожные сообщения об угрозе уничтожения корпоративных интересов. Недопустимый акт привёл к переходу актива под полный контроль КСО. На станции инициализирован уровень угрозы Гамма с протоколами военного положения, объявляется мобилизация экипажа. Инициировано развёртывание сил ОБР по вектору угрозы. Идём на Вы. Боже, Директорат храни!
...
ert-response-caused-messager-sierra =
    Внимание, станция! Первыми средствами связи командования были переданы тревожные сообщения об угрозе биологической катастрофы. Риск секторального загрязнения привёл к переходу актива под полный контроль КСО. На станции инициализирован уровень угрозы Сьерра с протоколами военного положения, объявляется мобилизация экипажа. Инициировано развёртывание сил РХБЗЗ по вектору угрозы. Огнём и мечом. Боже, Директорат храни!
