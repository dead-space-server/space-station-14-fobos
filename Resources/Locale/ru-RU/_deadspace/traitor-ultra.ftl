...
traitor-ultra-bounty-announcer =
    Организация «Синдикат»

traitor-ultra-bounty-announcement =
    Всем внимание! Один из наших агентов сменил условия контракта, его имя: «{$agent}». С момента данного оповещения за убийство данной персоны «Синдикат» предлагает большое вознаграждение в индивидуальном порядке. Напоминание: любая кооперация с данным агентом карается немедленной ликвидацией. Смерть NanoTrasen!
