...
public static class DeadSpaceStylePalette
{
    ...
    private static ThemePalette CreateDark()
    {
        var palette = new ThemePalette
        {
            ...
            Control = Neutral("#26313C"),
            ControlHover = Neutral("#32414E"),
            ControlPressed = Neutral("#3C4F5E"),
            ...
            Action = Neutral("#2A3642"),
            ActionHover = Neutral("#354653"),
            ActionPressed = Neutral("#415563"),
    ...
    private static ThemePalette CreateLight()
    {
        var palette = new ThemePalette
        {
            ...
            Control = Color.FromHex("#BCC7D0"),
            ControlHover = Color.FromHex("#DDD2C1"),
            ControlPressed = Color.FromHex("#CEB891"),
            ...
            Action = Color.FromHex("#B5C3CE"),
            ActionHover = Color.FromHex("#D9CBB7"),
            ActionPressed = Color.FromHex("#C7AD82"),
